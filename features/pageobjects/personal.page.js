...
class PersonalInfoPage extends Page {
    ...
    get verifyloggedinUser () { return $("//span[text()='Roy Json']") }
    ...
    async enterPersonalInfo () {
        ...
        await (await this.address).setValue('1300 Chicago 123 South,');
        await (await this.city).setValue('Chicago City');
        ...
        await (await this.mobileNum).setValue('+1 409-890-0000');
